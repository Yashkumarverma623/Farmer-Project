    ...
    <nav className="bg-yellow-400 p-4 shadow-lg fixed top-0 left-0 w-full z-50 h-auto">
      <div className="container mx-auto flex justify-between items-center">
        <div className="flex items-center space-x-3">
          <img src="#" alt="HealthEdPro Logo" className="w-12 h-12 rounded-full" />
          <div>
        ...
        <div className="hidden md:flex space-x-6 items-center ml-auto">
          ...
          <Link to="/Emergency" className="text-black flex items-center gap-1 hover:text-gray-700"><FaExclamationTriangle /> CheckOut</Link>
